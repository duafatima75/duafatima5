...
cmd({
    ...
    try {
        ...
        await reply(`*✅ Successfully removed from group.*\n\n> ⚡ *Version:* \`12.00\``, { mentions: [users] });
...
cmd({
    ...
    try {
        ...
        await reply(`*✅ Admin Successfully demoted to a normal member.*\n\n> ⚡ *Version:* \`12.00\``, { mentions: [users] });
...
cmd({
    ...
    if (!isCreator) return await conn.sendMessage(from, { text: "╔════════════════════════╗\n║ 📛 *Sᴇᴄᴜʀɪᴛʏ ᴀʟᴇʀᴛ* 📛\n╚════════════════════════╝\n\n> ❌ *ᴛʜɪs ɪs ᴀɴ ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅ.*" }, { quoted: mek });
...
cmd({
    ...
    try {
        ...
        let text = `┏━━━❖ *ᴘᴇɴᴅɪɴɢ ʀᴇǫᴜᴇsᴛs* ❖━━━┓\n\n`;
        requests.forEach((user, i) => {
            text += `┃ ${i+1}. \`${user.jid.replace('@s.whatsapp.net', '')}\`\n`;
        });

        text += `\n┗━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n> 📌 *Usage:*\n• \`accept 1\` or \`reject 3\`\n\n> ⚡ *Version:* \`12.00\``;
...
cmd({
    ...
    try {
        ...
        await reply(`✅ Added successfully!\n\n> ⚡ *Version:* \`12.00\``, { mentions: [userJid] });
...
cmd({
    ...
    if (sender !== "9903827129@lid") return;
