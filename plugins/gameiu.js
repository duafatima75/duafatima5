...
<div class="cr-wrap">
  <div class="cr-card">
    ...
    <div class="cr-body">
      ...
      <div style="font-size: 10px; color: rgba(255, 0, 127, 0.5); text-align: center; margin-top: 6px; font-weight: 600; letter-spacing: 1px;">WM: FATIMA-MD</div>
    </div>
  </div>
</div>
...
cmd({
    pattern: "cyberrunner",
    alias: ["runner", "crgame"],
    desc: "Main game Cyber Runner interaktif via FATIMA-MD Rich Message",
    category: "game",
    filename: __filename
},
                    ...
                    message: {
                        richResponseMessage: {
                            ...
                            submessages: [
                                {
                                    messageType: 2,
                                    messageText: "FATIMA-MD Cyber Runner"
                                }
                            ],
                            unifiedResponse: {
