// flappybird.js 
// ESM Plugin 
// code dari : https://whatsapp.com/channel/0029VbD8x4q1dAw0XWN7wF0L/275
...
<div class="flappyWrap">
  <div class="flappyHeader">
    ...
    <div class="flappyHeaderTitle">FATIMA-MD <span>BIRD</span></div>
  ...
  <div class="flappyGame" id="flappyGame">
    ...
    <div class="flappyStart" id="flappyStart">
      <div class="flappyTitle">FATIMA-MD BIRD</div>
  ...
  <div class="flappyFooter">
    ...
    <div class="flappyFooterText">FATIMA-MD</div>
...
cmd({
    pattern: "flappy",
    alias: ["flappybird"],
    desc: "Main game Flappy Bird interaktif via FATIMA-MD Rich Message",
    category: "game"
},
async (conn, mek, m, { from, reply }) => {
  ...
  try {
          ...
          message: {
            richResponseMessage: {
              ...
              submessages: [
                {
                  messageType: 2,
                  messageText: "FATIMA-MD Flappy Bird"
                }
              ],
              unifiedResponse: {
                data: Buffer.from(
    ...
    console.error(err);
    await reply('❌ Gagal mengirim game.');
  }
});
