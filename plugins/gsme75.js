...
<div class="gd-wrap">
  <div class="gd-card">
    ...
    <div class="gd-body">
      ...
      <div style="font-size: 10px; color: rgba(0, 243, 255, 0.5); text-align: center; margin-top: 6px; font-weight: 600; letter-spacing: 1px;">WM: FATIMA-MD</div>
    </div>
  </div>
</div>
...
cmd({
    ...
    desc: "Main game Geometry Dash Mini interaktif via FATIMA-MD Rich Message",
    category: "game",
    filename: __filename
},
                    ...
                    message: {
                        richResponseMessage: {
                            ...
                            submessages: [
                                {
                                    messageType: 2,
                                    messageText: "FATIMA-MD Geometry Dash Mini"
                                }
                            ],
                            unifiedResponse: {
